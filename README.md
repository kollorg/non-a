<div align="center">
  ...
  <div style="display: flex;justify-content:center;">
    <img src="https://img.shields.io/github/package-json/v/kollorg/non-a"></img>
    <img src="https://circleci.com/gh/kollorg/non-a.svg?style=svg"></img>
    <img src="https://img.shields.io/badge/License-MIT-blue.svg"/> 
    <img src="https://img.shields.io/npm/dt/@kollorg/non-a.svg"></img>
  </div>
</div>

`@kollorg/non-a` is an [Interactive Brokers](http://interactivebrokers.com/) TWS (or IB Gateway) Typescript API client library for [Node.js](http://nodejs.org/). It is a direct port of Interactive Brokers' Java Client Version 10.25 ("latest") from Sept 7 2023.
...
## Installation
    ...
    $ npm install @kollorg/non-a

or

    $ yarn add @kollorg/non-a
...
import { IBApi, EventName, ErrorCode, Contract } from "@kollorg/non-a";
...
If you want to contribute, read the [Developer Guide](https://github.com/kollorg/non-a/wiki/Developer-Guide) and start coding.
